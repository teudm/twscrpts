...
// @name       Auto Fake
// @version      0.1
// @match  https://*.tribalwars.com.br/*screen=place*
...
var tempo = 1000;
var x = 0;
var FakesPorAldeia = 2; //quantidade de fakes por aldiea
var sp = 0; // lanceiros
var sw = 0; // espadachins
var ax = 0; //barbaros
var scout = 10; //exploradores
...
if (tentCookie !== null) {
    ...
    if (doc.forms[0].x.value !== "") {
        ...
        cookie_date = new Date(2025, 11, 15);
        ...
        if (numAtaques < FakesPorAldeia) {
            if (numTentativas <= maxTentativas) {
                ...
                numAtaques = numAtaques + 1;
                coords = coords[index];
                console.log("Enviando fake para " + coords);
                coords = coords.split("|");
                index = index + 1;
                cookie_date = new Date(2025, 11, 15);
                document.cookie = cookieName + "=" + index + ";expires=" + cookie_date.toGMTString();
