...
(function () {
    ...
    function runScript() {
        ...
        function rebuild() {
            ...
            arrV.forEach(v => {
                ...
                // REMOVIDO: const triboMembers = triboData ? safeParseInt(triboData.members) : 0;
                ...
                else if (isAlly) tr.style.backgroundColor = "#e8f5e9"; // Mantido verde claro para aliado
                ...
                else if (status === "Ativo") tr.style.backgroundColor = "#e0ffe0"; // Verde muito claro para ativo
                ...
                if (playerId) {
                    ...
                    if (!isOwner) {
                        ...
                        graphContainerPlayer.id = 'graph_cont_p_' + playerId + '_' + v.id; // ID único incluindo ID da vila
                ...
                if (triboId && triboData) {
                    ...
                    let infoText = ""; // String vazia inicialmente
                    if (triboPoints > 0) { // Mostra pontos apenas se for maior que 0
                        infoText = `Pontos: ${triboPoints.toLocaleString('pt-BR')}`;
                    }
                    // REMOVIDO: Lógica de Membros
                    if (infoText) { // Só adiciona o span se tiver info para mostrar
    ...
    function waitForGameData() {
        ...
        const checker = setInterval(() => {
            // Condição de verificação mais completa
